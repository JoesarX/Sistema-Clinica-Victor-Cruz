...
function HistorialCita() {
    ...
    const generatePDF = (medicamentosData) => {
        ...
        doc.setFont("times");
        doc.setFontSize(6);
        doc.text("Nombre:", 1.20, 1.75);
        doc.text("Edad:", 4.25, 1.75);
        doc.text("Fecha:", 1.2, 2.15);
        ...
        doc.line(1.6, 1.75, 4.20, 1.75); // Line for Name
        doc.line(4.5, 1.75, 4.9, 1.75); // Line for Age
        doc.line(1.6, 2.15, 4.20, 2.15); // Line for Date
        ...
        //x1,y1  x2,y2
          ...
          //  autoSize: true,
            ...
            startY: 2.25, // Adjust the vertical position as needed
        ...
        doc.save('Receta_' + paciente.nombre + '_' + formatDate(paciente.fecha) + '.pdf');
    };
